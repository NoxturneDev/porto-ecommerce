...
const Contact = () => {
    return (
        <Fragment>
            <div className="flex flex-col mt-10  items-center h-screen min-h-max w-full justify-center">
                <h1 className="text-4xl mb-6">Contact Us</h1>
                <div className="flex mb-10 flex-col w-1/3 items-center text-center justify-center  ">
